resource "null_resource" "lambda_build" {
  ...
  provisioner "local-exec" {
    command = "CGO_ENABLED=0 GOOS=linux go build -o ${var.lambda_path}/${var.function_name}/main ${var.lambda_path}/${var.function_name}/main.go"
  }
}

data "archive_file" "this" {
  depends_on  = [null_resource.lambda_build]
  source_file = "${var.lambda_path}/${var.function_name}/main"
  output_path = "${var.lambda_path}/${var.function_name}/main.zip"
  type        = "zip"
}
